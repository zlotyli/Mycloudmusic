...
// 当为当前歌曲的歌词信息时
export const CHANGE_LYRIC_LIST = 'player/CHANGE_LYRICS_LIST';
// 当为当前歌曲的当前演唱歌词在总歌词中的索引时
...
// 当为当前歌曲的评论时
export const CHANGE_CURRENT_SONG_COMMENTS = 'player/CHANGE_CURRENT_SONG_SONG_COMMENTS'